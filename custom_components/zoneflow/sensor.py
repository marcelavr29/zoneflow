...
_GLOBAL_DEFS: list[ZoneFlowSensorDef] = [
    ...
    ZoneFlowSensorDef(
        key="rain_forecast_mm",
        name="Ploaie prevăzută (24h)",
        value_fn=lambda d: d.get("rain_forecast_mm"),
        unit="mm",
    ...
    ZoneFlowSensorDef(
        key="effective_target_mm",
        name="Țintă efectivă (după ploaie)",
        value_fn=lambda d: d.get("effective_target_mm"),
        unit="L/m²",
